...
router.post("/upload", upload_middleware_1.upload.single("file"), upload_middleware_1.validateMagicBytes, media_controller_1.uploadMedia);
router.put("/:id/rename", media_controller_1.renameMedia);
router.post("/:id/replace", upload_middleware_1.upload.single("file"), upload_middleware_1.validateMagicBytes, media_controller_1.replaceMedia);
