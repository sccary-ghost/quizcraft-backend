...
router.get("/analytics", auth_middleware_1.authenticate, user_controller_1.getAnalytics);
router.put("/goals", auth_middleware_1.authenticate, user_controller_1.updateGoals);
