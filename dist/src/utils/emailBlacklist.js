...
exports.isDisposableEmail = exports.DISPOSABLE_EMAIL_BLACKLIST = void 0;
// List of default disposable email domains that can be easily updated
exports.DISPOSABLE_EMAIL_BLACKLIST = [
    "mailinator.com",
    "yopmail.com",
    "dispostable.com",
    "tempmail.com",
...
const isDisposableEmail = (email) => {
    ...
    return exports.DISPOSABLE_EMAIL_BLACKLIST.some(blacklistedDomain => {
